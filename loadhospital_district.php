...
<html>
    ...
    <body>       
        <?php
       $sel=mysql_query("select * from org_data where stat='$s' and dis='$d' and st=1");
       if(mysql_num_rows($sel)>0)
       {
        ...
        <div class="col-lg-4">
            ...
            <?php
            $sel_hos=mysql_query("select * from org_data where stat='$s' and dis='$d' and org_typ='1' and st=1");
        ...
        <div class="col-lg-4">
            ...
            <?php
            $sel_hos=mysql_query("select * from org_data where stat='$s' and dis='$d' and org_typ='3' and st=1");
            if(mysql_num_rows($sel_hos)>0)
            {
                ?><br /><br />
            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
        ...
        <div class="col-lg-4">
            ...
            <?php
            $sel_hos=mysql_query("select * from org_data where stat='$s' and dis='$d' and org_typ='2' and st=1");
            if(mysql_num_rows($sel_hos)>0)
            {
                ?><br /><br />
            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
